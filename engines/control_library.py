...
CONTROLS = [
    ...
    dict(id="C02", element="Risk classification", framework="EU GMP Annex 22; EU AI Act; ICH Q9(R1); FDA 7-step credibility (draft Jan 2025)",
         clause="Criticality; model risk = model influence × decision consequence", control="Risk is classified against each applicable framework with documented rationale.",
    ...
    dict(id="C07", element="Human-in-the-loop & accountability", framework="EU GMP Annex 22; EU AI Act Art. 14; FDA 21 CFR 211.22 (Purolea WL 04/2026)",
         clause="Human oversight; QU review & clearance of AI output", control="A named human reviews/approves outputs before any GxP record action; accountability is assigned.",
    ...
    dict(id="C16", element="LLM-specific hallucination control", framework="EU GMP Annex 22 (deterministic-only; LLMs barred from critical GMP); FDA drugs AI guidance",
